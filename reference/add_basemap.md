...
- bbox:
  ...
  Bounding box as c(xmin, ymin, xmax, ymax) or sf bbox object in WGS84
  (EPSG:4326). Optional if data is provided.
...
- zoom_offset:
  ...
  Number of zoom levels to add to auto-calculated zoom (default 1). Use
  0 for auto zoom without offset, 2 or more for higher resolution.
